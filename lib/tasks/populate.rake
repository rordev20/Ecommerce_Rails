...
namespace :populate_data do
  ...
  task :populate_dummy_data => :environment do
    ...
    Product.create!(name: 'saree one', dimension: '1x2', description: 'saree one description', original_price: 90, purchase_price: 100, sub_category: SubCategory.first, is_active: true, color: Color.last, domestic_pos: 1, international_pos: 1, product_code: 'xyz', quantity: 10, vendor: Vendor.first)
