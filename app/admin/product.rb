ActiveAdmin.register Product do
  ...
  permit_params :name, :dimension, :description, :purchase_price, :vendor, :sub_category_id, :quantity, :color, :domestic_pos, :international_pos, :specification, :product_code,
